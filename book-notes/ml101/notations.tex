...
Example: $\chi_{d}^2$ distribution (sum of $d$ independent standard Gaussian r.v. squared, think throwing darts with x, y axis variations being Gaussian as a $\chi_{2}^2$. Expected value of $\chi_{d}^2$ is $d$), $\chi_2^{2}$ is exponential distribution $Exp(\frac{1}{2})$.
\\
\\
