...
\begin{pmatrix}
\langle \frac{\partial h}{\partial \theta_1} (\theta) \\
\dots \\
\langle \frac{\partial h}{\partial \theta_d} (\theta) \\
\end{pmatrix}
$$
...
\begin{pmatrix}
\langle \frac{\partial^2 h}{\partial \theta_1 \partial \theta_1} (\theta) \dots \frac{\partial^2 h}{\partial \theta_1 \partial \theta_d} (\theta) \\
\dots \\
\langle \frac{\partial^2 h}{\partial \theta_d \partial \theta_1} (\theta) \dots \frac{\partial^2 h}{\partial \theta_d \partial \theta_d} (\theta) \\
\end{pmatrix}
$$
...
$$
\argmin{\theta \in \Theta} \hat{KL}(\mathbb{P}_{\theta*}, \mathbb{P}_{\theta}) \iff \argmax{\theta in \Theta} \prod_{i = 1}^{n} p_{\theta}(X_i)
$$
