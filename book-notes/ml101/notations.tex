...
The frequentist approach, we estimate $p$ using the MLE, construct some confidence interval for $p$,
then did hypothesis testing (e.g. $H_0: p = 0.5$ vs $H_1: p \neq 0.5$).
...
(It often looks like adding one more observation that reflects your prior.)

The prior can look like, e.g. we are $90\%$ sure $p$ is between $.4$ and $.6$.
