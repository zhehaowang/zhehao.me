...
Given a general optimization problem: minimize $f_0(x)$ subject to $f_i(x) \leq 0, i = 1, \dots m$.
...
\lambda_i^* f_i(x^*) = 0
$$
Always have Lagrange multipler being zero, or constraint is active at optimum, or both.
